...
> **Nota:** la sesión 8 quedó agendada para el martes 18 de agosto porque el 17 de agosto es festivo. La sesión 7 (clase 3) todavía no tiene fecha asignada en su README — vale la pena confirmar si va antes o después del 18 de agosto. La fecha/bloque de la sesión 12 está marcada con `*` porque se infirió de las marcas de tiempo en sus scripts (no hay una fuente oficial que la confirme todavía).
