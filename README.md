...
| **Correquisito** | 2508207 — Matemáticas Discretas I |
...
- Usar arreglos unidimensionales y bidimensionales para almacenar y manipular datos.
- Aplicar los principios básicos de la programación orientada a objetos.
- Leer y escribir información en archivos para dar persistencia a los datos de un programa.
- Escribir algoritmos y programas en Python que resuelvan problemas computacionales reales.
...
| Unidad | Tema | Duración aproximada |
|---|---|---|
| 1 | Algoritmos Secuenciales | 2 semanas |
...
|---|---|
| 1 – 2 | Presentación del curso y Algoritmos Secuenciales |
| 3 | Primer laboratorio en Python · **Evaluación parcial 1** |
| 4 – 5 | Estructuras de Control Selectivas |
| 5 – 7 | Estructuras de Control Repetitivas · **Evaluación parcial 2** |
| 8 – 9 | Programación Orientada a Objetos · **Evaluación parcial 3** |
| 10 – 11 | Arreglos Unidimensionales |
| 11 – 13 | Arreglos Bidimensionales y Archivos |
...
| Momento de evaluación | Contenido evaluado | Porcentaje |
|---|---|---|
...
- Guías de trabajo independiente por unidad.
- Presentaciones utilizadas en los encuentros sincrónicos.
- Notebooks interactivos de Python (ejecutables en Google Colaboratory).
- Talleres autocalificados en la plataforma del Departamento.
- Espacio del curso en la plataforma virtual institucional.
- Foros de discusión y atención por correo electrónico para resolver dudas.
...
| Referencia | Enfoque |
|---|---|
| Skiena, S. S. *The Algorithm Design Manual*, 3ª ed., Springer, 2020 | Algoritmos y estructuras de datos |
| Mailund, T. *Introduction to Computational Thinking*, Apress, 2021 | Pensamiento computacional y Python |
| Klein, S. T. *Basic Concepts in Algorithms*, World Scientific, 2021 | Diseño de algoritmos |
| Aguilar, L. *Fundamentos de programación*, 5ª ed., McGraw Hill, 2020 | Algoritmos y programación (en español) |
...
- **Correo electrónico del docente:** disponible para consultas fuera del horario de clase.
- **Atención presencial o virtual:** según disponibilidad acordada con el docente.
...
- Este curso tiene como correquisito **Matemáticas Discretas I**, por lo que se recomienda cursar ambas asignaturas de forma articulada.
- Se espera del estudiante autonomía, responsabilidad y disposición para el trabajo colaborativo, valores centrales de la metodología de aula invertida.

---

*Documento elaborado como guía general del curso Lógica y Representación I — Universidad de Antioquia.*